...
class ResPartner(models.Model):
    ...
    abuse = fields.Boolean(string='History of Abuse / Trauma',
                           help='Clinical documentation of physical, psychological, or sexual trauma')
    ...
    oral = fields.Boolean(string='Oral Mucosal Screening',
                          help='Oral mucosal examination and exposure screening')
    anal = fields.Boolean(string='Anorectal Screening',
                          help='Clinical anorectal examination indicator')
    prostitute = fields.Boolean(string='High-Risk Exposure',
                                help='Documented history of high-risk commercial or partner exposure')
    prostitute_sex = fields.Boolean(string='Contact with High-Risk Partner',
                                    help='Clinical history of contact with high-risk partner')
    sex_notes = fields.Text(string='Sexual Health Notes',
                            help='Confidential clinical observations regarding sexual and reproductive health')
    ...
    def action_generate_patient_card(self):
        ...
        return self.env.ref(
            'hospital_managment_os.action_report_patient_card'
