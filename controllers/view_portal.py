...
class ViewPortal(http.Controller):
    ...
    def portal_my_vaccine(self, **kw):
        ...
        return request.render("hospital_managment_os.portal_my_vaccines",
                              values)
    ...
    def portal_my_tests(self, **kw):
        ...
        return request.render("hospital_managment_os.portal_my_tests",
                              values)
    ...
    def tests_view(self, test_id):
        ...
        return request.render(
            "hospital_managment_os.portal_my_tests_results", values)
    ...
    def portal_my_op(self, **kw):
        ...
        return request.render(
            "hospital_managment_os.portal_my_op", values)
